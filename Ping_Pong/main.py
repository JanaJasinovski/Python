...
class Game(tk.Frame):
    ...
    def setup_game(self):
        ...
        self.text = self.draw_text(300, 200, 'Нажмите пробел')
    ...
    def game_loop(self):
        ...
        if num_bricks == 0:
            ...
            self.text = self.draw_text(300, 200, 'Ты выиграл!')
            self.after(1000, self.play_again)
        elif self.ball.get_position()[3] >= self.height:
            self.ball.speed = None
            self.lives -= 1
            if self.lives < 0:
                self.text = self.draw_text(300, 200, 'Игра окончена')
                self.after(1000, self.play_again)
            else:
    ...
    def play_again(self):
        self.canvas.delete(self.text)
        self.text = self.draw_text(300, 200, 'Играть снова? ( y or n)')
        self.canvas.bind('<y>', lambda _: self.restart_game())
        self.canvas.bind('<n>', lambda _: self.end_game())
    ...
    def end_game(self):
        self.canvas.delete(self.text)
        self.text = self.draw_text(300, 200, 'Спасибо за игру!')
